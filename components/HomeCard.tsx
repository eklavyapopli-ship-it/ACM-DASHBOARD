...
<div className={cn(' mt-10 px-4 py-6 flex flex-col justify-between w-full xl:max-w-[300px] min-h-[220px] rounded-[14px] cursor-pointer',className)} onClick={handleClick}>
